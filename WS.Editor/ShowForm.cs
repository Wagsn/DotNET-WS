...
{
    /// <summary>
    /// 第三方EXE嵌入，参考：http://bbs.csdn.net/topics/390344060
    /// </summary>
    public class ShowForm
    {
        ...
        {
            ShowForm Sf = new ShowForm(new Form(), "仅供内部使用" + System.Guid.NewGuid().ToString());
            var proxHandle = Sf.Start(Application.StartupPath + "\\ProxyThorn.exe");
            //proxHandle.
        }
    }
}
